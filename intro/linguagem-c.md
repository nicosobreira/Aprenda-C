...
Nos, humanos, temos a capacidade de interpretar e executar diferentes tarefas, de diferentes formas, graças a nossa razão e lógica. Em contraste, o computador está limitado a lidar com apenas: zeros e uns; e um número reduzido de operações.
...
Quando estamos criando nossos primeiros programas em C, não queremos nos preocupar com elementos de UI, como botões e animações, queremos um jeito simples e fácil de exibir o necessário e focar na lógica do nosso programa. É aí que o terminal entra! Ele é um jeito dos usuários se comunicarem com o nosso programa apenas por texto, sem depender do mouse, simplificando a interação com o programa.
